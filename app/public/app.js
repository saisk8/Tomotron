$(document).ready(function () {
  ...
  $('#sminus').click(function () {
    ...
    $('#sdisplay').text(sessionLen);
    $('#timer').text((sessionLen < 10 ? '0' + sessionLen : sessionLen) + ':00');
  });
  ...
  $('#setter').click(function () {
    if ($('#setter').text() === 'Start') {
      ...
      $('#setter').text('Pause');
      $('#setter').removeClass('btn-outline-primary');
      $('#setter').addClass('btn-outline-warning');
    } else if ($('#setter').text() === 'Pause') {
      clockPause = true;
      pauseClock();
      $('#setter').text('Start');
      $('#setter').removeClass('btn-outline-warning');
      $('#setter').addClass('btn-outline-primary');
    }
  });
